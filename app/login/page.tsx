...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      ...
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-zinc-900 via-black to-zinc-900 pointer-events-none" />
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/reset" className="text-sm text-[#e78a53] hover:text-[#e78a53]/80">
                Forgot password?
              </Link>
            </div>
            ...
            <Button
              type="submit"
              disabled={!canSubmit}
              className="w-full bg-[#e78a53] hover:bg-[#e78a53]/90 text-white font-medium py-3 rounded-xl transition-colors disabled:opacity-70"
            >
        ...
        >
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <Button
              ...
              className="bg-zinc-900/50 border-zinc-800 text-zinc-300 hover:bg-zinc-900 hover:border-[#e78a53]/60 transition-all duration-200 group"
            >
              <svg className="w-5 h-5 mr-2 text-zinc-300 group-hover:text-[#e78a53] transition-colors duration-200" viewBox="0 0 24 24">
            ...
            <Button
              ...
              className="bg-zinc-900/50 border-zinc-800 text-zinc-300 hover:bg-zinc-900 hover:border-[#e78a53]/60 transition-all duration-200 group"
            >
              <svg className="w-5 h-5 mr-2 text-zinc-300 group-hover:text-[#e78a53] transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24">
