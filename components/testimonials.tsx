...
const testimonials = [
  {
    name: "Sarah Chen",
    username: "@sarahsec",
    body: "Detectify caught a deepfake video of our CEO before it went viral. Saved our company's reputation.",
    img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Marcus Johnson",
    username: "@marcusj",
    body: "As a journalist, verifying media authenticity is crucial. This tool has become indispensable for our newsroom.",
    img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Elena Rodriguez",
    username: "@elena_tech",
    body: "The real-time detection is incredibly fast. We integrated it into our platform and users love the added security.",
    img: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "David Kim",
    username: "@davidkim_ai",
    body: "Finally, a deepfake detector that actually works. The accuracy is impressive and the API is easy to integrate.",
    img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Priya Patel",
    username: "@priyap_security",
    body: "We use Detectify to protect our clients' digital identities. The forensic reports are detailed and court-ready.",
    img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "James Wilson",
    username: "@jwilson_media",
    body: "Detected manipulated audio in a critical interview. This technology is a game-changer for media verification.",
    img: "https://images.unsplash.com/photo-1472099644761-15a19d654956?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Aisha Mohammed",
    username: "@aisha_cyber",
    body: "The AI continuously learns and adapts. We've seen detection accuracy improve month over month.",
    img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Tom Anderson",
    username: "@tom_infosec",
    body: "Enterprise-grade protection at a reasonable price. The white-label option was perfect for our security suite.",
    img: "https://images.unsplash.com/photo-1507591064344-4c6ce005b128?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Lisa Zhang",
    username: "@lisaz_tech",
    body: "Caught deepfakes that other tools missed. The multi-modal analysis (video + audio) is incredibly thorough.",
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-[540px]">
          ...
          <p className="mt-5 relative z-10 text-center text-lg text-zinc-500">
            From cybersecurity teams to media organizations, Detectify protects digital authenticity worldwide.
          </p>
        </div>
